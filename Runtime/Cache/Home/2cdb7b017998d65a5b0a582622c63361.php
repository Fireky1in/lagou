        	...
        	<dl class="c_section c_section_service">
                ...
                <dd>
                	...
                	<div class="open_service_success">
	                	<h3>验证邮件已发送至：alex@tonebrand.cn</h3>
	            	...
	            	<div class="open_service_success_btm">
	                 	<h5>没有收到确认邮件，怎么办？</h5>
	                   	<div class="contacttip">
	                    	1.邮箱地址填写错误？ <a href="http://www.lagou.com/corpCenter/bindStep1.html?update=1">重新填写邮箱地址</a> <br>
							2.看看是否在邮箱的垃圾邮件、广告邮件目录里<br>
							3.稍等几分钟，若还未收到验证邮件，  <a href="javascript:void(0)" id="resendOpenService">重新发送验证邮件</a> <br>
							4.还未收到验证邮件，请联系vivi@lagou.com，注明"未收到验证邮件"，我们会为你重新发送。
						</div>
        ...
        <div style="display:none;">
        	...
        	-->
                <div id="resend_success" class="popup">
                	<p>我们已将激活邮件发送至：<a>alex@tonebrand.cn</a>，请点击邮件内的链接完成验证。</p>
                	                </div><!--/#resend_success-->
        </div>
        <!-- ----------------------------------- end ----------------------------------- -->
    </div>
...
<link href="/Public/css3/main.css" rel="stylesheet">
			...
			<div class="clear"></div>
			<input id="resubmitToken" value="4bde748aa7de4c0bb25924b6a952aa8e" type="hidden">
