...
<html>
    <head>
        ...
        <link href="/lagou2/Public/HomeStyle/css/style.css" type="text/css" rel="stylesheet">
         <script type="text/javascript" src="/lagou2/Public/HomeStyle/js/jquery.1.10.1.min.js"></script>
        <script src="/lagou2/Public/HomeStyle/js/jquery.lib.min.js" type="text/javascript"></script>
        <script type="text/javascript" src="/lagou2/Public/HomeStyle/js/ajaxfileupload.js"></script>
        <script src="/lagou2/Public/HomeStyle/js/additional-methods.js" type="text/javascript"></script>
        <!--[if lte IE 8]>
            <script type="text/javascript" src="/lagou2/Public/HomeStyle/js/excanvas.js">
            </script>
        <![endif]-->
        <script src="/lagou2/Public/HomeStyle/js/ajaxCross.json" charset="UTF-8"></script>
    </head>
    
    <body>
        <div id="body">
            <link href="/lagou2/Public/css3/header.css" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="/lagou2/Public/css3/style_002.css">
<link rel="stylesheet" type="text/css" href="/lagou2/Public/css3/style.css">
<link rel="stylesheet" type="text/css" href="/lagou2/Public/css3/external.css">
<link rel="stylesheet" type="text/css" href="/lagou2/Public/css3/popup.css">
<div id="lg_tbar">
         <div class="inner">
...
<div id="lg_tnav">
                ...
                <div class="content_mid">
                    ...
                    <dl class="c_section c_section_service">
                        ...
                        <dd>
                            ...
                            <form class="corp_form" id="bindForm" action="<?php echo U('CompanyRegOpen/step1');?>" method="post" onsubmit="return $.sub(this);">
        ...
        <script src="/lagou2/Public/HomeStyle/js/core.min.js" type="text/javascript"></script>
        <!-- end #body -->
        <link href="/lagou2/Public/css3/main.css" rel="stylesheet">
<div id="footer">
		<div class="wrapper">
