...
<script charset="utf-8" src="/Public/Home/companyshow/v.js"></script>
<script async="" src="/Public/Home/companyshow/analytics.js"></script>
<script async="" src="/Public/Home/companyshow/a.js"></script>
...
<div id="content-container">
    ...
    <div class="company_navs_wrap">
        <ul data-pjax="">
            ...
            <li><a href="<?php echo U('Home/CompanyShow/lists');?>?cid=<?php echo ($com_more["id"]); ?>">招聘职位（<?php echo count($zpjob);?>）</a></li>
        </ul>
...
<div class="company_navs_shadow" style="display: none;"></div>    
    ...
    <div class="item_content">
            <!-- 展示模式 -->
        <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="product_content" data-id="4627">
                <img src="<?php echo ($vo["image"]); ?>">
                <div class="product_details">
                    <h4 title="<?php echo ($com_more["web"]); ?>" class="product_url_all"><div class="<?php echo ($com_more["web"]); ?>" title="<?php echo ($com_more["web"]); ?>"><a href="<?php echo ($com_more["web"]); ?>" class="url_valid" target="_blank" rel="nofollow"><?php echo ($vo["name"]); ?></a><a title="http://leancloud.cn" href="http://leancloud.cn/" target="_blank" rel="nofollow"><i class="product_url"></i></a></div></h4>
...
<br><br><br><br><br><?php echo ($vo["desc"]); ?>
                    </div>
                </div>
            </div>
                </div><!--end .item_content-->
        
        </div><!--end #company_products--><?php endforeach; endif; else: echo "" ;endif; ?>       
                <!-- 公司介绍 -->
...
<div class="address_container item_container" id="location_container">
    ...
    <div class="item_content">
        ...
        <ul class="con_mlist_ul">
                <li class="mlist_ul_li mlist_li_open " data-locationid="3540">
                    <p class="mlist_li_title">
                        <em class="li_title_iconinx">1</em>
                        <span title="北京市，海淀区" class="li_title_text ellipsis"><?php echo ($com_more["city"]); ?></span>
                                                <em class="li_title_corner"></em>
                    </p>
                    <p class="mlist_li_desc">
                        <?php echo ($com_more["city"]); ?>金澳国际商业区
                    </p>
                </li>
             </ul>
        </div></div>
...
<div class="posfilterlist_container item_container">
    ...
    <h3 class="item_ltitle">
        近两月共有 <span class="list_total">13</span> 个在招职位
    </h3>
    ...
    <div class="item_content">
        ...
        <!-- 筛选框 -->
        <div class="item_con_filter" style="display:none;">
            <span class="con_filter_type">
                职位：
            </span>
...
<script id="tpl-position-list" type="text/html">
   ...
   {{each data as item i}}
    <li class="con_list_item" data-positionid="{{item.positionId}}" data-salary="{{item.salary}}" data-company="LeanCloud" data-positionname="{{item.positionName}}">
        <p class="item_title_date">
            <a href="http://www.lagou.com/jobs/{{item.positionId}}.html" data-index="{{i}}" target="_blank" class="item_title position_link" rel="nofollow">
...
<!-- <script type="text/javascript" src="/Public/Home/companyshow/api"></script> -->
<script type="text/javascript" src="/Public/Home/companyshow/getscript"></script>
